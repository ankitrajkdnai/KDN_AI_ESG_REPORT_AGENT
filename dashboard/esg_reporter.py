...
st.markdown('## AI agent for compliance with Environmental, Social, and Governance Reports 🌱')
...
def main():
    ...
    if query and ('vectordb' in st.session_state):
        ...
        Avoid mentioning the company's name directly in your answer.
        Include numerical figures if relevant.
        If you don't know the answer, just say that information is not available; don't try to make up an answer.
        Keep the answer concise and present as bullet points.
        Use ESG-related news to provide compliance related advices at last.
        Also mention Financial Risks related to this
